...
import com.vados.nasa_photo.databinding.FragmentGreetingsPotdBinding
...
class GreetingsFirstFragment:Fragment() {
    ...
    private var _binding: FragmentGreetingsPotdBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGreetingsPotdBinding.inflate(inflater)
